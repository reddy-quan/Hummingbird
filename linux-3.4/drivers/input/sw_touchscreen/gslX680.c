...
static void ft5x_report_singletouch(struct gsl_ts *ts, u16 x, u16 y, u8 pressure, u8 id)
{
...
#else
	         ft5x_report_singletouch(ts, x_new, y_new, 10, id);
