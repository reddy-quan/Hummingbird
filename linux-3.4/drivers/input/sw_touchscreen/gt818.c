...
//extern struct ctp_config_xy config_xy;
...
static void goodix_ts_early_suspend(struct early_suspend *h)
{
    ...
    GTP_DEBUG_FUNC();
    ctp_set_int_port_rate(config_info.int_number, 0);
	ctp_set_int_port_deb(config_info.int_number, 0x00);
#if GTP_ESD_PROTECT
    ts->gtp_is_suspend = 1;
