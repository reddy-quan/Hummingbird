...
/********************************** Defines ***********************************/
/*begin quanjia modify the path to under wwwdemo folder 20130101*/
#define DEFAULT_CERT_FILE   "./wwwdemo/certSrv.pem"		/* Public key certificate */
#define DEFAULT_KEY_FILE    "./wwwdemo/privkeySrv.pem"	/* Private key file */
