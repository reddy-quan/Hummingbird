...
CPPFLAGS="-I/opt/ssh/install/openssl-0.9.8e/include -I/opt/ssh/install/zlib-1.2.3/include "
LDFLAGS="-L/opt/ssh/install/openssl-0.9.8e/lib -L/opt/ssh/install/zlib-1.2.3/lib  -fstack-protector-all"
